...
//		anuncio en un periódico.
		...
		Object testingData[][] = {
				...
				//Caso de test 2: NEGATIVO. Comportamiento: No puede registrar un anucio como usuario
				...
				//Caso de test 3: NEGATIVO. Comportamiento: No puede registrar el anuncio con el título vacio
...
//	anuncio en un periódico.
		...
		Object testingData[][] = {
				//Caso de test 1: POSITIVO. Comportamiento: Como se describe anteriormente.
				{"agent1", "agent1","title1", "https://i.imgur.com/mz4KOzY.png", "https://i.imgur.com/mz4KOzY.png", "newspaper1",null},
				//Caso de test 2: NEGATIVO. Comportamiento: No puede realizarse como customer
				...
				//Caso de test 3: NEGATIVO. Comportamiento: No puede realizarse ya que la url de la imagen del anuncio está vacia
				{"agent1", "agent1","title1", "", "https://i.imgur.com/mz4KOzY.png", "newspaper1",IllegalArgumentException.class},
				//Caso de test 4: NEGATIVO. Comportamiento: No puede realizarse ya que la url del target page del anuncio está vacia
				{"agent1", "agent1","title1", "https://i.imgur.com/mz4KOzY.png", "", "newspaper1",IllegalArgumentException.class}
